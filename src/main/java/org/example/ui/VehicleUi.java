...
public class VehicleUi {
    ...
    public VehicleUi(){
        JFrame jFrame = new JFrame("Vehicle UI");
        ...
        String data[][]= vehicleService.getByNameJTable();
        String column[]={"ID","NAME","MODEL","BRAND","COLOR","O_ID"};
        ...
        btn3.addActionListener(e -> {
            if (jt.getRowCount() != 0) {
                ...
                if (selectedRow != -1) {
                    ...
                    Object[] gettingId = new Object[model.getColumnCount()];
                    for (int i=0 ; i< df.getColumnCount() ; i++){
                        gettingId[i] = df.getValueAt(selectedRow,i);
                    }
                    long id = Long.parseLong(""+gettingId[0]);
                    vehicleService.deleteRow(id);
        ...
        search.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                String[][] data = vehicleService.getByName(search.getText());
                DefaultTableModel df = new DefaultTableModel(data,column);
                jt.setModel(df);
            }
        });
